      ...
      <View className="flex-1 pt-16">
        ...
        <View className="flex-1 bg-[#FBFAF6] rounded-t-[28px] px-6 pt-8 pb-7 shadow-sm">
          ...
          <Pressable
            onPress={submit}
            disabled={loading}
            className={`h-14 rounded-2xl bg-[#15151A] flex-row items-center justify-center gap-2 mt-2 active:scale-[0.97] transition-transform ${loading ? 'opacity-70' : 'opacity-100'}`}
          >
            {loading ? (
          ...
          <Pressable className="h-[52px] rounded-xl border border-[#1515151A] bg-transparent flex-row items-center justify-center gap-2.5 active:scale-[0.97] transition-transform">
