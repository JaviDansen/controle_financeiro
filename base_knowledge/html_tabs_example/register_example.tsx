// register_example.tsx
// FinApp — Tela de cadastro (Register), em TSX.
//
// Composição idêntica à versão original: barra superior com voltar + wordmark,
// título grande, card branco com 4 inputs, checkbox de termos, CTA e link p/ login.

import React, { useState } from 'react';
import {
  GlobalStyle, Icon, Field, FinAppMark,
} from './finapp_shared';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Field
            ...
            value={nome}
            onChange={setNome}
            placeholder="Walber Vidigal"
            icon={<Icon.Profile size={18} />}
          />
          <Field
            label="E-mail"
            type="email"
          ...
          <button
            ...
            style={{
              ...
              fontSize: 13, textAlign: 'left', lineHeight: 1.5, cursor: 'pointer',
            }}
          >
            <span style={{
              ...
              {accept && <Icon.Check size={12} sw={2.5} />}
            </span>
            <span>
              Eu li e aceito os{' '}
              <span style={{ color: 'var(--ink)', fontWeight: 500, textDecoration: 'underline', textUnderlineOffset: 3 }}>
                Termos de uso
              </span>{' '}
              e a{' '}
              <span style={{ color: 'var(--ink)', fontWeight: 500, textDecoration: 'underline', textUnderlineOffset: 3 }}>
