// dashboard_example.tsx
// FinApp — Tela inicial (Dashboard), em TSX.
//
// Composição: header com avatar + saudação, card hero do saldo do mês com
// mini-gráfico de barras e split receita/despesa, lista de últimas transações
// e carrossel horizontal dos cartões de crédito.

import React, { useState } from 'react';
import {
  GlobalStyle, Icon,
  TRANSACTIONS, CARDS, SUMMARY,
  fmtBRLShort,
  TxRow,
  Card,
} from './finapp_shared';
...
function Sparkbars({
  data, color = 'var(--ink)', height = 36,
}: SparkbarsProps): React.ReactElement {
...
/* ─── Mini card resumo (carrossel) ────────────────────────────────────── */

interface MiniCardSummaryProps {
  card: Card;
  onTap?: () => void;
}

function MiniCardSummary({ card, onTap }: MiniCardSummaryProps): React.ReactElement {
  return (
    <button
      onClick={onTap}
      type="button"
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <div style={{ fontSize: 11, opacity: 0.7, fontWeight: 500, letterSpacing: '0.04em', textTransform: 'uppercase' }}>
            {card.bank}
          </div>
          <div style={{ fontSize: 15, fontWeight: 500, marginTop: 2 }}>{card.name}</div>
        </div>
        <div className="finapp-mono" style={{ fontSize: 11, opacity: 0.7 }}>
          •• {card.last4}
        </div>
      </div>
      ...
      <div style={{ marginTop: 'auto' }}>
        ...
        <div className="finapp-mono" style={{ fontSize: 20, fontWeight: 500, letterSpacing: '-0.02em' }}>
...
export default function DashboardScreen({
  ...
  const creditCards = CARDS.filter((c: Card) => c.type === 'credit');
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ padding: '14px 16px 0' }}>
          <div style={{
            ...
            <svg width="160" height="160" viewBox="0 0 160 160"
              ...
              <rect width="160" height="160" fill="url(#dash-grid)" />
            </svg>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <button
                ...
                style={{
                  ...
                  display: 'flex', padding: 6, borderRadius: 999, cursor: 'pointer',
                }}
              >
            ...
            <div style={{
              fontSize: 12, opacity: 0.6, marginTop: 14, fontWeight: 500,
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6, marginTop: 4 }}>
              ...
              <span className="finapp-mono" style={{ fontSize: 40, fontWeight: 500, letterSpacing: '-0.04em', lineHeight: 1 }}>
            ...
            <div style={{ marginTop: 18 }}>
              <div style={{
                ...
                marginBottom: 6, whiteSpace: 'nowrap', gap: 8,
              }}>
                <span>Despesas — últimos 14 dias</span>
                <span className="finapp-mono">R$ {fmtBRLShort(SUMMARY.expense)}</span>
              </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: 11, opacity: 0.7 }}>
                  <span style={{
                    width: 14, height: 14, borderRadius: 999, background: 'var(--accent)',
                    display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: '#0A0A0A',
                  }}>
                    <Icon.ArrowDn size={9} sw={2.5} />
                  </span>
                  Receitas
                </div>
                <div className="finapp-mono" style={{ fontSize: 16, fontWeight: 500, marginTop: 4 }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: 11, opacity: 0.7 }}>
                  <span style={{
                    width: 14, height: 14, borderRadius: 999, background: 'var(--neg)',
        ...
        {/* Recent transactions */}
        <div style={{
          padding: '24px 22px 6px', display: 'flex', alignItems: 'center', justifyContent: 'space-between',
        }}>
          <h2 style={{
            margin: 0, fontSize: 17, fontWeight: 500, color: 'var(--ink)', letterSpacing: '-0.02em',
          }}>Últimas transações</h2>
          <button type="button" style={linkBtn}>Ver todas</button>
        </div>
        <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            margin: 0, fontSize: 17, fontWeight: 500, color: 'var(--ink)', letterSpacing: '-0.02em',
          }}>Cartões de crédito</h2>
          <button type="button" style={linkBtn} onClick={onOpenCards}>Ver todos</button>
        </div>
